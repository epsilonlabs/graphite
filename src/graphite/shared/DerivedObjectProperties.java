...
public class DerivedObjectProperties {
	...
	public DerivedObjectProperties(DerivedPropertyData derivedPropertyData, XtextEObject containerObject) {
		try {
			...
			this.identifierGetterMethod = derivedPropertyData.getType().getMethod(ModelUtility.getIdentifierMethodName(derivedPropertyData.getType()));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public ITransformationService getTransformationService() {
		return derivedPropertyData.getTransformationService();
	}
	
	public boolean isTransformed() {
		return derivedPropertyData.isTransformed();
	}
