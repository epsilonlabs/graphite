...
public class EffortsSyntacticSequencer extends AbstractSyntacticSequencer {

	protected EffortsGrammarAccess grammarAccess;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (EffortsGrammarAccess) access;
	}
