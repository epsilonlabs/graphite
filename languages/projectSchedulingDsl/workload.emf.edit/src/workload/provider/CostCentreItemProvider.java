 ...
 * @generated
 */
public class CostCentreItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CostCentre_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CostCentre_name_feature", "_UI_CostCentre_type"),
				 WorkloadPackage.Literals.COST_CENTRE__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_CostCentre_efforts_feature", "_UI_CostCentre_type"),
				 WorkloadPackage.Literals.COST_CENTRE__EFFORTS,
				 true,
				 false,
				 true,
				 null,
