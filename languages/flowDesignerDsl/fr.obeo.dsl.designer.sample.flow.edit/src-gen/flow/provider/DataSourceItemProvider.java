...
/**
 * This is the item provider adapter for a {@link flow.DataSource} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataSourceItemProvider extends FlowSourceItemProvider {
	/**
	...
	protected void addVolumePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataSource_volume_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataSource_volume_feature", "_UI_DataSource_type"),
				 FlowPackage.Literals.DATA_SOURCE__VOLUME,
				 true,
				 false,
				 false,
