...
/**
 * This is the item provider adapter for a {@link flow.DataFlow} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataFlowItemProvider extends CapacityBoundItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FlowPackage.Literals.DATA_FLOW__TARGET,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FlowPackage.Literals.DATA_FLOW__SOURCE,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		FlowElementUsage labelValue = ((DataFlow)object).getUsage();
