 ...
 * </p>
 * <ul>
 *   <li>{@link flow.impl.ProcessorImpl#getCapacity <em>Capacity</em>}</li>
 *   <li>{@link flow.impl.ProcessorImpl#getLoad <em>Load</em>}</li>
 *   <li>{@link flow.impl.ProcessorImpl#getOutgoingFlows <em>Outgoing Flows</em>}</li>
 *   <li>{@link flow.impl.ProcessorImpl#getConsumption <em>Consumption</em>}</li>
 *   <li>{@link flow.impl.ProcessorImpl#getPowerStatus <em>Power Status</em>}</li>
 *   <li>{@link flow.impl.ProcessorImpl#getName <em>Name</em>}</li>
 *   <li>{@link flow.impl.ProcessorImpl#getVolume <em>Volume</em>}</li>
 *   <li>{@link flow.impl.ProcessorImpl#getWeight <em>Weight</em>}</li>
 * </ul>
 *
 * @generated
 */
