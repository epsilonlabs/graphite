...
import fr.obeo.dsl.designer.sample.flow.ComparisonOperator;
import fr.obeo.dsl.designer.sample.flow.FlowPackage;
import fr.obeo.dsl.designer.sample.flow.Named;
import fr.obeo.dsl.designer.sample.flow.PropertyUnit;
import fr.obeo.dsl.designer.sample.flow.RoutingRule;

import fr.obeo.dsl.designer.sample.flow.SystemProperty;
import fr.obeo.dsl.designer.sample.flow.SystemStatus;
 ...
 * </p>
 * <ul>
 *   <li>{@link fr.obeo.dsl.designer.sample.flow.impl.RoutingRuleImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link fr.obeo.dsl.designer.sample.flow.impl.RoutingRuleImpl#getPropertyName <em>Property Name</em>}</li>
 *   <li>{@link fr.obeo.dsl.designer.sample.flow.impl.RoutingRuleImpl#getUnit <em>Unit</em>}</li>
 *   <li>{@link fr.obeo.dsl.designer.sample.flow.impl.RoutingRuleImpl#getComparisonOperator <em>Comparison Operator</em>}</li>
 *   <li>{@link fr.obeo.dsl.designer.sample.flow.impl.RoutingRuleImpl#getValue <em>Value</em>}</li>
 *   <li>{@link fr.obeo.dsl.designer.sample.flow.impl.RoutingRuleImpl#getSystemStatus <em>System Status</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RoutingRuleImpl extends EObjectImpl implements RoutingRule {
	 ...
	 * @ordered
	 */
	protected fr.obeo.dsl.designer.sample.flow.System target;
	 ...
	 * @generated
	 */
	public fr.obeo.dsl.designer.sample.flow.System getTarget() {
		if (target != null && target.eIsProxy()) {
			InternalEObject oldTarget = (InternalEObject)target;
			target = (fr.obeo.dsl.designer.sample.flow.System)eResolveProxy(oldTarget);
			if (target != oldTarget) {
	 ...
	 * @generated
	 */
	public fr.obeo.dsl.designer.sample.flow.System basicGetTarget() {
		return target;
	}
	 ...
	 * @generated
	 */
	public void setTarget(fr.obeo.dsl.designer.sample.flow.System newTarget) {
		fr.obeo.dsl.designer.sample.flow.System oldTarget = target;
		target = newTarget;
		if (eNotificationRequired())
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FlowPackage.ROUTING_RULE__TARGET:
				setTarget((fr.obeo.dsl.designer.sample.flow.System)newValue);
				return;
			case FlowPackage.ROUTING_RULE__PROPERTY_NAME:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case FlowPackage.ROUTING_RULE__TARGET:
				setTarget((fr.obeo.dsl.designer.sample.flow.System)null);
				return;
			case FlowPackage.ROUTING_RULE__PROPERTY_NAME:
