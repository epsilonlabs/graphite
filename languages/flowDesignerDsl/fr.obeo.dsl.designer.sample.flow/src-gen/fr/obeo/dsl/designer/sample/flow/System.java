 ...
 *   <li>{@link fr.obeo.dsl.designer.sample.flow.System#getRoutingRulesList <em>Routing Rules List</em>}</li>
 * </ul>
 *
...
public interface System extends Powered, FlowSource, Named {
	 ...
	 * The list contents are of type {@link fr.obeo.dsl.designer.sample.flow.RoutingRule}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Routing Rules List</em>' containment reference list.
	 * @see fr.obeo.dsl.designer.sample.flow.FlowPackage#getSystem_RoutingRulesList()
	 * @model containment="true"
	 * @generated
	 */
