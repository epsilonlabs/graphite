...
public class InternalReplicationMappingsLexer extends Lexer {
    ...
    public final void mRULE_NEWLINE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalReplicationMappings.g:1091:14: ( ( ' ' | '\\t' )* ( '\\r' )? '\\n' ( ' ' | '\\t' )* )
            // InternalReplicationMappings.g:1091:16: ( ' ' | '\\t' )* ( '\\r' )? '\\n' ( ' ' | '\\t' )*
            {
            // InternalReplicationMappings.g:1091:16: ( ' ' | '\\t' )*
            loop1:
            do {
                int alt1=2;
            ...
            // InternalReplicationMappings.g:1091:28: ( '\\r' )?
            int alt2=2;
            ...
            match('\n'); 
            // InternalReplicationMappings.g:1091:39: ( ' ' | '\\t' )*
            loop3:
            do {
                int alt3=2;
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalReplicationMappings.g:1093:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalReplicationMappings.g:1093:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalReplicationMappings.g:1093:11: ( '^' )?
            int alt4=2;
            ...
            // InternalReplicationMappings.g:1093:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop5:
            do {
                int alt5=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalReplicationMappings.g:1095:10: ( ( '0' .. '9' )+ )
            // InternalReplicationMappings.g:1095:12: ( '0' .. '9' )+
            {
            // InternalReplicationMappings.g:1095:12: ( '0' .. '9' )+
            int cnt6=0;
            loop6:
            do {
                ...
                switch (alt6) {
            	case 1 :
            	    // InternalReplicationMappings.g:1095:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalReplicationMappings.g:1097:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalReplicationMappings.g:1097:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalReplicationMappings.g:1097:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt9=2;
            ...
            switch (alt9) {
                case 1 :
                    // InternalReplicationMappings.g:1097:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalReplicationMappings.g:1097:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop7:
                    do {
                        int alt7=3;
                        ...
                        switch (alt7) {
                    	case 1 :
                    	    // InternalReplicationMappings.g:1097:21: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalReplicationMappings.g:1097:28: ~ ( ( '\\\\' | '\"' ) )
                    	    {
                    ...
                    break;
                case 2 :
                    // InternalReplicationMappings.g:1097:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalReplicationMappings.g:1097:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop8:
                    do {
                        int alt8=3;
                        ...
                        switch (alt8) {
                    	case 1 :
                    	    // InternalReplicationMappings.g:1097:54: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalReplicationMappings.g:1097:61: ~ ( ( '\\\\' | '\\'' ) )
                    	    {
                    	    if ( (input.LA(1)>='\u0000' && input.LA(1)<='&')||(input.LA(1)>='(' && input.LA(1)<='[')||(input.LA(1)>=']' && input.LA(1)<='\uFFFF') ) {
                    	        input.consume();
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalReplicationMappings.g:1099:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalReplicationMappings.g:1099:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalReplicationMappings.g:1099:24: ( options {greedy=false; } : . )*
            loop10:
            do {
                int alt10=2;
                ...
                switch (alt10) {
            	case 1 :
            	    // InternalReplicationMappings.g:1099:52: .
            	    {
            	    matchAny(); 
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalReplicationMappings.g:1101:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalReplicationMappings.g:1101:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalReplicationMappings.g:1101:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop11:
            do {
                int alt11=2;
            ...
            // InternalReplicationMappings.g:1101:40: ( ( '\\r' )? '\\n' )?
            int alt13=2;
            ...
            switch (alt13) {
                case 1 :
                    // InternalReplicationMappings.g:1101:41: ( '\\r' )? '\\n'
                    {
                    // InternalReplicationMappings.g:1101:41: ( '\\r' )?
                    int alt12=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalReplicationMappings.g:1103:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalReplicationMappings.g:1103:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalReplicationMappings.g:1103:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt14=0;
            loop14:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalReplicationMappings.g:1105:16: ( . )
            // InternalReplicationMappings.g:1105:18: .
            {
            matchAny(); 
    ...
    static final String DFA15_eotS =
        "\1\uffff\1\25\3\uffff\1\32\2\uffff\1\32\1\23\2\37\1\44\1\23\2\uffff\3\23\6\uffff\1\32\3\uffff\1\32\2\uffff\1\37\1\44\1\37\1\44\5\uffff\6\32\1\61\1\32\1\uffff\12\32\1\75\1\uffff";
    static final String DFA15_eofS =
        "\76\uffff";
    static final String DFA15_minS =
        "\1\0\1\76\3\uffff\1\157\2\uffff\1\141\1\55\1\11\1\12\1\11\1\101\2\uffff\2\0\1\52\6\uffff\1\154\3\uffff\1\170\2\uffff\1\12\3\11\5\uffff\1\151\1\137\1\143\1\164\1\171\1\162\1\60\1\141\1\uffff\1\156\1\163\1\146\1\145\1\162\1\137\1\162\1\141\1\164\1\145\1\60\1\uffff";
    static final String DFA15_maxS =
        "\1\uffff\1\76\3\uffff\1\157\2\uffff\1\141\1\55\1\40\1\12\1\40\1\172\2\uffff\2\uffff\1\57\6\uffff\1\154\3\uffff\1\170\2\uffff\1\12\3\40\5\uffff\1\151\1\137\1\143\1\164\1\171\1\162\1\172\1\141\1\uffff\1\156\1\163\1\146\1\145\1\162\1\137\1\162\1\141\1\164\1\145\1\172\1\uffff";
    static final String DFA15_acceptS =
        "\2\uffff\1\2\1\3\1\4\1\uffff\1\6\1\7\6\uffff\1\14\1\15\3\uffff\1\22\1\1\1\11\1\2\1\3\1\4\1\uffff\1\14\1\6\1\7\1\uffff\1\12\1\21\4\uffff\1\13\1\15\1\16\1\17\1\20\10\uffff\1\5\13\uffff\1\10";
    static final String DFA15_specialS =
        "\1\1\17\uffff\1\2\1\0\54\uffff}>";
    static final String[] DFA15_transitionS = {
            "\11\23\1\12\1\14\2\23\1\13\22\23\1\12\1\23\1\20\4\23\1\21\4\23\1\7\1\1\1\2\1\22\12\17\1\6\1\23\1\11\4\23\32\16\3\23\1\15\1\16\1\23\14\16\1\10\2\16\1\5\12\16\1\3\1\23\1\4\uff82\23",
            "\1\24",
            "",
            "",
            "",
