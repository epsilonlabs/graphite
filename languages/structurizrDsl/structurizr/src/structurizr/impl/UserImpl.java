 ...
 * </p>
 * <ul>
 *   <li>{@link structurizr.impl.UserImpl#getUsername <em>Username</em>}</li>
 *   <li>{@link structurizr.impl.UserImpl#getPermission <em>Permission</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UserImpl extends CustomEObjectImpl implements User {
	/**
	...
	protected EClass eStaticClass() {
		return StructurizrPackage.Literals.USER;
	}
	...
	public void setUsername(String newUsername) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StructurizrPackage.USER__USERNAME, oldUsername, username));
	}
	...
	public void setPermission(UserPermission newPermission) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StructurizrPackage.USER__PERMISSION, oldPermission, permission));
	}
