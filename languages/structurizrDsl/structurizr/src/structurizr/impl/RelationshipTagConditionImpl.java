...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Relationship Tag Condition</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link structurizr.impl.RelationshipTagConditionImpl#getComparisonOperation <em>Comparison Operation</em>}</li>
 *   <li>{@link structurizr.impl.RelationshipTagConditionImpl#getTags <em>Tags</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RelationshipTagConditionImpl extends RelationshipFilterConditionImpl implements RelationshipTagCondition {
	/**
	 ...
	 * @generated
	 */
	protected RelationshipTagConditionImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return StructurizrPackage.Literals.RELATIONSHIP_TAG_CONDITION;
	}
	...
	public void setComparisonOperation(ConditionComparisonOperation newComparisonOperation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StructurizrPackage.RELATIONSHIP_TAG_CONDITION__COMPARISON_OPERATION, oldComparisonOperation, comparisonOperation));
	}
	...
	public EList<Tag> getTags() {
		if (tags == null) {
			tags = new EObjectResolvingEList<Tag>(Tag.class, this, StructurizrPackage.RELATIONSHIP_TAG_CONDITION__TAGS);
		}
		return tags;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case StructurizrPackage.RELATIONSHIP_TAG_CONDITION__TAGS:
				return getTags();
		}
