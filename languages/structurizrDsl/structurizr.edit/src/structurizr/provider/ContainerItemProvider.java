...
/**
 * This is the item provider adapter for a {@link structurizr.Container} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ContainerItemProvider extends C4ElementItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StructurizrPackage.Literals.CONTAINER__TECHNOLOGY);
			childrenFeatures.add(StructurizrPackage.Literals.CONTAINER__COMPONENTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(StructurizrPackage.Literals.CONTAINER__TECHNOLOGY,
				 StructurizrFactory.eINSTANCE.createTechnology()));

		newChildDescriptors.add
			(createChildParameter
				(StructurizrPackage.Literals.CONTAINER__COMPONENTS,
				 StructurizrFactory.eINSTANCE.createComponent()));
	}
