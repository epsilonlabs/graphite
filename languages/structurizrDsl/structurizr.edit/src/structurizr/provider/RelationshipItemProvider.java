...
/**
 * This is the item provider adapter for a {@link structurizr.Relationship} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RelationshipItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StructurizrPackage.Literals.RELATIONSHIP__SOURCE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StructurizrPackage.Literals.RELATIONSHIP__TARGET,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Relationship_description_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Relationship_description_feature", "_UI_Relationship_type"),
				 StructurizrPackage.Literals.RELATIONSHIP__DESCRIPTION,
				 true,
				 false,
				 false,
	...
	protected void addUrlPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Relationship_url_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Relationship_url_feature", "_UI_Relationship_type"),
				 StructurizrPackage.Literals.RELATIONSHIP__URL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StructurizrPackage.Literals.RELATIONSHIP__TECHNOLOGY);
			childrenFeatures.add(StructurizrPackage.Literals.RELATIONSHIP__TAGS);
			childrenFeatures.add(StructurizrPackage.Literals.RELATIONSHIP__PROPERTIES);
			childrenFeatures.add(StructurizrPackage.Literals.RELATIONSHIP__PERSPECTIVES);
		}
	...
	public String getText(Object object) {
		String label = ((Relationship)object).getDescription();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(StructurizrPackage.Literals.RELATIONSHIP__TECHNOLOGY,
				 StructurizrFactory.eINSTANCE.createTechnology()));

		newChildDescriptors.add
			(createChildParameter
				(StructurizrPackage.Literals.RELATIONSHIP__TAGS,
				 StructurizrFactory.eINSTANCE.createTag()));

		newChildDescriptors.add
			(createChildParameter
				(StructurizrPackage.Literals.RELATIONSHIP__PROPERTIES,
				 StructurizrFactory.eINSTANCE.createProperty()));

		newChildDescriptors.add
			(createChildParameter
				(StructurizrPackage.Literals.RELATIONSHIP__PERSPECTIVES,
