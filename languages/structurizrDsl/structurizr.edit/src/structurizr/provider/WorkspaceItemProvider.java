...
/**
 * This is the item provider adapter for a {@link structurizr.Workspace} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WorkspaceItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StructurizrPackage.Literals.WORKSPACE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Workspace_description_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Workspace_description_feature", "_UI_Workspace_type"),
				 StructurizrPackage.Literals.WORKSPACE__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StructurizrPackage.Literals.WORKSPACE__MODEL);
			childrenFeatures.add(StructurizrPackage.Literals.WORKSPACE__VIEWS);
			childrenFeatures.add(StructurizrPackage.Literals.WORKSPACE__PROPERTIES);
			childrenFeatures.add(StructurizrPackage.Literals.WORKSPACE__CONFIGURATION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(StructurizrPackage.Literals.WORKSPACE__MODEL,
				 StructurizrFactory.eINSTANCE.createModel()));

		newChildDescriptors.add
			(createChildParameter
				(StructurizrPackage.Literals.WORKSPACE__VIEWS,
				 StructurizrFactory.eINSTANCE.createViews()));

		newChildDescriptors.add
			(createChildParameter
				(StructurizrPackage.Literals.WORKSPACE__PROPERTIES,
				 StructurizrFactory.eINSTANCE.createProperty()));

		newChildDescriptors.add
			(createChildParameter
				(StructurizrPackage.Literals.WORKSPACE__CONFIGURATION,
				 StructurizrFactory.eINSTANCE.createConfiguration()));
	}
