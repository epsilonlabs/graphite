...
/**
 * This is the item provider adapter for a {@link structurizr.User} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UserItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StructurizrPackage.Literals.USER__USERNAME,
				 true,
				 false,
				 false,
	...
	protected void addPermissionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_User_permission_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_User_permission_feature", "_UI_User_type"),
				 StructurizrPackage.Literals.USER__PERMISSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(User.class)) {
			case StructurizrPackage.USER__USERNAME:
			case StructurizrPackage.USER__PERMISSION:
