...
/**
 * This is the item provider adapter for a {@link structurizr.DeploymentGroup} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DeploymentGroupItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DeploymentGroup_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DeploymentGroup_name_feature", "_UI_DeploymentGroup_type"),
				 StructurizrPackage.Literals.DEPLOYMENT_GROUP__NAME,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DeploymentGroup.class)) {
			case StructurizrPackage.DEPLOYMENT_GROUP__NAME:
