...
/**
 * This is the item provider adapter for a {@link structurizr.IdentifiableElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IdentifiableElementItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_IdentifiableElement_identifier_feature", "_UI_IdentifiableElement_type"),
				 StructurizrPackage.Literals.IDENTIFIABLE_ELEMENT__IDENTIFIER,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StructurizrPackage.Literals.IDENTIFIABLE_ELEMENT__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StructurizrPackage.Literals.IDENTIFIABLE_ELEMENT__RELATIONSHIPS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(IdentifiableElement.class)) {
			case StructurizrPackage.IDENTIFIABLE_ELEMENT__IDENTIFIER:
			case StructurizrPackage.IDENTIFIABLE_ELEMENT__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case StructurizrPackage.IDENTIFIABLE_ELEMENT__RELATIONSHIPS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(StructurizrPackage.Literals.IDENTIFIABLE_ELEMENT__RELATIONSHIPS,
