...
/**
 * This is the item provider adapter for a {@link structurizr.Element} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ElementItemProvider extends C4ElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Element_metadata_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Element_metadata_feature", "_UI_Element_type"),
				 StructurizrPackage.Literals.ELEMENT__METADATA,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Element.class)) {
			case StructurizrPackage.ELEMENT__METADATA:
