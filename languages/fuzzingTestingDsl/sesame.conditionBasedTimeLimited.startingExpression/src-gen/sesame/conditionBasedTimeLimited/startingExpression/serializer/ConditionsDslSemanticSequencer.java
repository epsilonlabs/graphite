 ...
 */
package sesame.conditionBasedTimeLimited.startingExpression.serializer;
...
public class ConditionsDslSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == FuzzingOperationsPackage.eINSTANCE)
			...
			case FuzzingOperationsPackage.CONDITION_BASED_TIME_LIMITED:
				sequence_ConditionBasedTimeLimited(context, (ConditionBasedTimeLimited) semanticObject); 
				return; 
			}
	 ...
	 * <pre>
	 * Contexts:
	 *     ConditionBasedTimeLimited returns ConditionBasedTimeLimited
	 *
	 * Constraint:
	 *     starting=Condition?
	 * </pre>
	 */
	protected void sequence_ConditionBasedTimeLimited(ISerializationContext context, ConditionBasedTimeLimited semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
