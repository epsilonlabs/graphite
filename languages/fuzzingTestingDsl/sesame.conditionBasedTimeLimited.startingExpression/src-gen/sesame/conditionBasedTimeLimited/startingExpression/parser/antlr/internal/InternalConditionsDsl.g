...
// Entry rule entryRuleConditionBasedTimeLimited
entryRuleConditionBasedTimeLimited returns [EObject current=null]:
	...
	{ $current=$iv_ruleConditionBasedTimeLimited.current; }
	EOF;

// Rule ConditionBasedTimeLimited
ruleConditionBasedTimeLimited returns [EObject current=null]
@init {
	enterRule();
}
@after {
