 ...
 */
package sesame.conditionBasedTimeLimited.startingExpression.services;
...
public class ConditionsDslGrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	...
	public class ConditionBasedTimeLimitedElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "sesame.conditionBasedTimeLimited.startingExpression.ConditionsDsl.ConditionBasedTimeLimited");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Action cConditionBasedTimeLimitedAction_0 = (Action)cGroup.eContents().get(0);
		...
		//ConditionBasedTimeLimited returns FuzzingOperations::ConditionBasedTimeLimited:
		//    {FuzzingOperations::ConditionBasedTimeLimited}
		//    (starting=Condition)?
		//    ;
		...
		//{FuzzingOperations::ConditionBasedTimeLimited}
		public Action getConditionBasedTimeLimitedAction_0() { return cConditionBasedTimeLimitedAction_0; }
	...
	public class ConditionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "sesame.conditionBasedTimeLimited.startingExpression.ConditionsDsl.Condition");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ConditionElementElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "sesame.conditionBasedTimeLimited.startingExpression.ConditionsDsl.ConditionElement");
	...
	public class BasicConditionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "sesame.conditionBasedTimeLimited.startingExpression.ConditionsDsl.BasicCondition");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class CompositeConditionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "sesame.conditionBasedTimeLimited.startingExpression.ConditionsDsl.CompositeCondition");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ConditionExprElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "sesame.conditionBasedTimeLimited.startingExpression.ConditionsDsl.ConditionExpr");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class ConditionVariableElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "sesame.conditionBasedTimeLimited.startingExpression.ConditionsDsl.ConditionVariable");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ConditionIntegerElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "sesame.conditionBasedTimeLimited.startingExpression.ConditionsDsl.ConditionInteger");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class EStringElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "sesame.conditionBasedTimeLimited.startingExpression.ConditionsDsl.EString");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class EIntElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "sesame.conditionBasedTimeLimited.startingExpression.ConditionsDsl.EInt");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class EBooleanElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "sesame.conditionBasedTimeLimited.startingExpression.ConditionsDsl.EBoolean");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class EDoubleElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "sesame.conditionBasedTimeLimited.startingExpression.ConditionsDsl.EDouble");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cHyphenMinusKeyword_0 = (Keyword)cGroup.eContents().get(0);
		private final RuleCall cINTTerminalRuleCall_1 = (RuleCall)cGroup.eContents().get(1);
	...
	public class BinaryComparisonOperationElements extends AbstractElementFinder.AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "sesame.conditionBasedTimeLimited.startingExpression.ConditionsDsl.BinaryComparisonOperation");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class BinaryLogicalOperationElements extends AbstractElementFinder.AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "sesame.conditionBasedTimeLimited.startingExpression.ConditionsDsl.BinaryLogicalOperation");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	private final ConditionBasedTimeLimitedElements pConditionBasedTimeLimited;
	...
	public ConditionsDslGrammarAccess(GrammarProvider grammarProvider,
		...
		this.pConditionBasedTimeLimited = new ConditionBasedTimeLimitedElements();
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("sesame.conditionBasedTimeLimited.startingExpression.ConditionsDsl".equals(grammar.getName())) {
				return grammar;
			}
	...
	//    (starting=Condition)?
	//    ;
	public ConditionBasedTimeLimitedElements getConditionBasedTimeLimitedAccess() {
		return pConditionBasedTimeLimited;
	}
	
	public ParserRule getConditionBasedTimeLimitedRule() {
		return getConditionBasedTimeLimitedAccess().getRule();
	}
