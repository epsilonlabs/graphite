 ...
 */
package sesame.conditionBasedActivation.startingEndingExpression.ide.contentassist.antlr;
...
import sesame.conditionBasedActivation.startingEndingExpression.ide.contentassist.antlr.internal.InternalConditionsDslParser;
...
public class ConditionsDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, ConditionsDslGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getMainRulesAccess().getAlternatives(), "rule__MainRules__Alternatives");
			...
			builder.put(grammarAccess.getConditionBasedActivationStartingAccess().getGroup(), "rule__ConditionBasedActivationStarting__Group__0");
			builder.put(grammarAccess.getConditionBasedActivationEndingAccess().getGroup(), "rule__ConditionBasedActivationEnding__Group__0");
			...
			builder.put(grammarAccess.getConditionBasedActivationStartingAccess().getStartingAssignment_1(), "rule__ConditionBasedActivationStarting__StartingAssignment_1");
			builder.put(grammarAccess.getConditionBasedActivationEndingAccess().getEndingAssignment_1(), "rule__ConditionBasedActivationEnding__EndingAssignment_1");
