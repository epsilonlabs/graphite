...
/**
 * This is the item provider adapter for a {@link TestingPackage.FuzzingOperations.ValueSet} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ValueSetItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ValueSet_propertyName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ValueSet_propertyName_feature", "_UI_ValueSet_type"),
				 FuzzingOperationsPackage.Literals.VALUE_SET__PROPERTY_NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((ValueSet)object).getPropertyName();
