...
/**
 * This is the item provider adapter for a {@link TestingPackage.MRSPackage.Node} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MRSPackagePackage.Literals.NODE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addSubscriberPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Node_subscriber_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Node_subscriber_feature", "_UI_Node_type"),
				 MRSPackagePackage.Literals.NODE__SUBSCRIBER,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addPublisherPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Node_publisher_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Node_publisher_feature", "_UI_Node_type"),
				 MRSPackagePackage.Literals.NODE__PUBLISHER,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MRSPackagePackage.Literals.NODE__PROPERTIES,
				 true,
				 false,
				 true,
				 null,
