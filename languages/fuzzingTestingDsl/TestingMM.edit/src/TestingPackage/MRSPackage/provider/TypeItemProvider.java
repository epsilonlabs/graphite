...
/**
 * This is the item provider adapter for a {@link TestingPackage.MRSPackage.Type} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TypeItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addParsingMethodPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MRSPackagePackage.Literals.TYPE__NAME,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Parsing Method feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addParsingMethodPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Type_parsingMethod_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Type_parsingMethod_feature", "_UI_Type_type"),
				 MRSPackagePackage.Literals.TYPE__PARSING_METHOD,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MRSPackagePackage.Literals.TYPE__PARAMETERS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MRSPackagePackage.Literals.TYPE__PARAMETERS,
				 MRSPackageFactory.eINSTANCE.createParameter()));
	}
