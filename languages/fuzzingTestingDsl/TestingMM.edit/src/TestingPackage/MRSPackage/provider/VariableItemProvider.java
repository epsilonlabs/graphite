...
/**
 * This is the item provider adapter for a {@link TestingPackage.MRSPackage.Variable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MRSPackagePackage.Literals.VARIABLE__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MRSPackagePackage.Literals.VARIABLE__TYPE,
				 true,
				 false,
				 true,
				 null,
