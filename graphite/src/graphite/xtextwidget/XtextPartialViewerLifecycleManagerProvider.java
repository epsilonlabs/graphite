...
import graphite.xtextxmi.LanguageProperties;

public class XtextPartialViewerLifecycleManagerProvider implements IEEFLifecycleManagerProvider {
	
	@Override
	public boolean canHandle(EEFControlDescription controlDescription) {
		return (controlDescription instanceof EEFCustomWidgetDescription) && (Objects.equals(LanguageProperties.getXtextWidgetId(), controlDescription.getIdentifier()));
	}
