...
public class WorkloadPackageImpl extends EPackageImpl implements WorkloadPackage {
	...
	public static WorkloadPackage init() {
		...
		WorkloadPackageImpl theWorkloadPackage = registeredWorkloadPackage instanceof WorkloadPackageImpl
				? (WorkloadPackageImpl) registeredWorkloadPackage
				: new WorkloadPackageImpl();
	...
	public void initializePackageContents() {
		...
		initEReference(getProject_Tasks(), this.getTask(), null, "tasks", null, 0, -1, Project.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getProject_People(), this.getPerson(), null, "people", null, 0, -1, Project.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		...
		initEAttribute(getTask_EffortsExpression(), ecorePackage.getEString(), "effortsExpression", null, 0, 1,
				Task.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getTask_Efforts(), this.getEffort(), null, "efforts", null, 0, -1, Task.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getTask_Leader(), this.getPerson(), null, "leader", null, 0, 1, Task.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getTask_Dependencies(), this.getTask(), null, "dependencies", null, 0, -1, Task.class,
		...
		initEReference(getEffort_Person(), this.getPerson(), null, "person", null, 0, 1, Effort.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getEffort_Months(), ecorePackage.getEInt(), "months", null, 0, 1, Effort.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(costCentreEClass, CostCentre.class, "CostCentre", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getCostCentre_Name(), ecorePackage.getEString(), "name", null, 0, 1, CostCentre.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCostCentre_Efforts(), this.getEffort(), null, "efforts", null, 0, -1, CostCentre.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createSyntaxAnnotations() {
		...
		addAnnotation(getTask_EffortsExpression(), source,
				new String[] { "grammar", "workload.xtext_grammar.Efforts", "derive", "efforts" });
	}
