...
public class TaskImpl extends CustomEObjectImpl implements Task {
	...
	public void setEffortsExpression(String newEffortsExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WorkloadPackage.TASK__EFFORTS_EXPRESSION,
					oldEffortsExpression, effortsExpression));
	}
	...
	public Person getLeader() {
		if (leader != null && leader.eIsProxy()) {
			...
			if (leader != oldLeader) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WorkloadPackage.TASK__LEADER, oldLeader,
							leader));
			}
		}
		return leader;
	...
	public boolean eIsSet(int featureID) {
		...
		case WorkloadPackage.TASK__EFFORTS_EXPRESSION:
			return EFFORTS_EXPRESSION_EDEFAULT == null ? effortsExpression != null
					: !EFFORTS_EXPRESSION_EDEFAULT.equals(effortsExpression);
		case WorkloadPackage.TASK__EFFORTS:
